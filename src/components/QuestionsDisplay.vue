    ...
    <v-row class="justify-center">
      ...
      <v-col cols="9" sm="1">
        ...
        <v-btn
          ...
          @click="addQuestion(question, index)"
          :disabled="questionAdded"
        />
        <v-btn
          size="small"
      ...
      <div v-if="this.question.showOptions">
        <Options
          ...
          @deleteOption="deleteOption(option, index)"
          @saveOption="saveOption(option, index)"
        />
      </div>
